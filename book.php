                ...
                <fieldset>
                    ...
                    <div class="book-one">
                        <div class="book-box">
                            ...
                            Package Name
                            <input type="text" placeholder="enter the package name" name="p_name" id="box-c"> 
                        </div>
                        <div class="book-box">
                            Package Price
                            <input type="number" placeholder="" id="box-c" name="price" >
                        </div>
                        <div class="book-box">
                            Package Location
                            <input type="text" placeholder="" id="box-c" name="location" >
          </div>
                </fieldset>
                <fieldset>
