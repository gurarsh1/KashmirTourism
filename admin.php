...
<body>
    ...
    <div class="admin-form">
        ...
        <form class="admins-form"  method="post" ><br>
           
            
            <label class="admin-username">username</label><br>
            <input type="username" id="admin-username" name="username" placeholder="enter you username"><br><br>
            <label class="admin-password">password</label><br>
            <input type="password" id="admin-password" name="password" placeholder="enter you password"><br>
            ...
            <button id="register-acc"><a href="register.html">register new account</a></button>
            <button id="admin-button" type="submit">login</button>
        </form>
    </div>
